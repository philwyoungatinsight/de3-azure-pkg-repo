...
# Add entries under "<your-pkg>/_stack/azure/<region>/<env>/buckets/test-bucket" to set:
#
#   resource_group_name: my-project-test-bucket-rg        # defaults to <project_prefix>-test-bucket-rg
#   storage_account_name: myprojecttestbkt                # globally unique, 3-24 lowercase alphanumeric
#   container_name: test-data                             # defaults to unit name
#   location: eastus                                      # defaults to region
#
